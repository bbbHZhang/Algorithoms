...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        /* YOUR CODE HERE */
        //should not use equals since not define equals so that would be == 
        if (Double.compare(this.x, that.x) == 0 && Double.compare(this.y, that.y) == 0) {
...
//        return Comparator.comparingDouble(this::slopeTo).thenComparing(this::compareTo);
    }
